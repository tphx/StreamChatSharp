...
<i>Disclaimer:
This repository is an independent third party library. It is in no way, officially or unofficially, licensed, supported, endorsed, or even acknowledged by <a href="http://www.twitch.tv/">Twitch.tv</a>. It is meant to interact with the publicly available IRC chat service that Twitch.tv provides. By using this library you accept all liabilities and are responsible for following all rules and terms set forth by the owners of the server you are connecting to. This software is used at your own risk.</i>
